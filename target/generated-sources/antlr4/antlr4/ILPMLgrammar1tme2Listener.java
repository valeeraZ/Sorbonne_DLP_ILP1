...
public interface ILPMLgrammar1tme2Listener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterVariableAssignment(@NotNull ILPMLgrammar1tme2Parser.VariableAssignmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code VariableAssignment}
	 * labeled alternative in {@link ILPMLgrammar1tme2Parser#expr}.
	 * @param ctx the parse tree
	 */
	void exitVariableAssignment(@NotNull ILPMLgrammar1tme2Parser.VariableAssignmentContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link ILPMLgrammar1tme2Parser#fundef}.
	 * @param ctx the parse tree
	 */
	void enterFundef(@NotNull ILPMLgrammar1tme2Parser.FundefContext ctx);
	/**
	 * Exit a parse tree produced by {@link ILPMLgrammar1tme2Parser#fundef}.
	 * @param ctx the parse tree
	 */
	void exitFundef(@NotNull ILPMLgrammar1tme2Parser.FundefContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterWhileLoop(@NotNull ILPMLgrammar1tme2Parser.WhileLoopContext ctx);
	/**
	 * Exit a parse tree produced by the {@code WhileLoop}
	 * labeled alternative in {@link ILPMLgrammar1tme2Parser#expr}.
	 * @param ctx the parse tree
	 */
	void exitWhileLoop(@NotNull ILPMLgrammar1tme2Parser.WhileLoopContext ctx);
}